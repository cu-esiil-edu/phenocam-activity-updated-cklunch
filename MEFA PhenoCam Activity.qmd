...
```{r}
# Create a subset of only evergreen needleleaf sites 
EN_sites <- subset(sitelist_table, primary_veg_type == "EN")  
...
```{r}
# Download PhenoCam images
download_midday_images(site = "NEON.D16.WREF.DP1.00033",
                       y = year, 
                       months = 1:12, 
                       days = 15,
                       download_dir = dir)
